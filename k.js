...
function randomTargetTime(minTime, targetTime, maxTime) {
    ...
    while (i < 100) {
        ...
        var randomTime = random.weibull(targetTime, 2);
        // Applies bounds
...
function getInfo() {
    ...
    page.open('http://www.kijiji.ca/b-apartments-condos/ottawa/page-1/c37l1700185', function (status) {
            ...
            page.includeJs("http://ajax.googleapis.com/ajax/libs/jquery/1.6.1/jquery.min.js", function() {
                ...
                setTimeout(function() {
                    var info = page.evaluate(function() {
                        ...
                        return [dateTime, data_214, data_212, data_211, data_215, data_213, data_216];
                    })
                    console.log(info);
                }, 3000);
            });
...
function timeOut() {
    setTimeout(function() {
        getInfo();
        timeOut();
    }, randomTargetTime(3*60, 6*60, 18*60));
}
